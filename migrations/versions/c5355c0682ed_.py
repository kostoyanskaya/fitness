...
Revision ID: c5355c0682ed
Revises: 
Create Date: 2025-01-15 22:22:52.493071
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['day_of_week_id'], ['day_of_week.id'], ondelete='CASCADE'),
